...
smrt bbdecompose -b $WORKDIR/consense-exabayes.nex -a $WORKDIR/aligned-smrt-inserted.txt -t $WORKDIR/taxa-replicated.tsv -w $WORKDIR
smrt clademerge --enrich -w $WORKDIR
smrt cladeinfer --ngens=15_000_000 --sfreq=1000 --lfreq=1000 -w $WORKDIR
smrt cladegraft -w $WORKDIR -o tree-reestimated.nex -b consense-exabayes.nex
